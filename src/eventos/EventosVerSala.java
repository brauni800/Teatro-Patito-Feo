...
public class EventosVerSala extends EventosFactory {
	...
	protected void initEvents() {
		...
		super.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getBtnAsientosSeleccionados()
				.addActionListener(this);
		super.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getBtnAsientosSeleccionados()
				.setActionCommand(PanelFactory.ASIENTOS_SELECCIONADOS);
	 ...
	 * 
	 * @param jl
	 *            Label a lo que se le agregará la funcionalidad.
	 * @param coordenada
	...
	private void agregandoEventos() {
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA10()
				.addMouseListener(asientoAdapter(jl, "A-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA11()
				.addMouseListener(asientoAdapter(jl, "A-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA12()
				.addMouseListener(asientoAdapter(jl, "A-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA13()
				.addMouseListener(asientoAdapter(jl, "A-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA14()
				.addMouseListener(asientoAdapter(jl, "A-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA15()
				.addMouseListener(asientoAdapter(jl, "A-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA16()
				.addMouseListener(asientoAdapter(jl, "A-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA17()
				.addMouseListener(asientoAdapter(jl, "A-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA18()
				.addMouseListener(asientoAdapter(jl, "A-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA19()
				.addMouseListener(asientoAdapter(jl, "A-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getA20()
				.addMouseListener(asientoAdapter(jl, "A-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB10()
				.addMouseListener(asientoAdapter(jl, "B-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB11()
				.addMouseListener(asientoAdapter(jl, "B-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB12()
				.addMouseListener(asientoAdapter(jl, "B-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB13()
				.addMouseListener(asientoAdapter(jl, "B-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB14()
				.addMouseListener(asientoAdapter(jl, "B-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB15()
				.addMouseListener(asientoAdapter(jl, "B-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB16()
				.addMouseListener(asientoAdapter(jl, "B-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB17()
				.addMouseListener(asientoAdapter(jl, "B-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB18()
				.addMouseListener(asientoAdapter(jl, "B-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB19()
				.addMouseListener(asientoAdapter(jl, "B-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getB20()
				.addMouseListener(asientoAdapter(jl, "B-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC10()
				.addMouseListener(asientoAdapter(jl, "C-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC11()
				.addMouseListener(asientoAdapter(jl, "C-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC12()
				.addMouseListener(asientoAdapter(jl, "C-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC13()
				.addMouseListener(asientoAdapter(jl, "C-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC14()
				.addMouseListener(asientoAdapter(jl, "C-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC15()
				.addMouseListener(asientoAdapter(jl, "C-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC16()
				.addMouseListener(asientoAdapter(jl, "C-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC17()
				.addMouseListener(asientoAdapter(jl, "C-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC18()
				.addMouseListener(asientoAdapter(jl, "C-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC19()
				.addMouseListener(asientoAdapter(jl, "C-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getC20()
				.addMouseListener(asientoAdapter(jl, "C-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD10()
				.addMouseListener(asientoAdapter(jl, "D-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD11()
				.addMouseListener(asientoAdapter(jl, "D-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD12()
				.addMouseListener(asientoAdapter(jl, "D-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD13()
				.addMouseListener(asientoAdapter(jl, "D-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD14()
				.addMouseListener(asientoAdapter(jl, "D-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD15()
				.addMouseListener(asientoAdapter(jl, "D-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD16()
				.addMouseListener(asientoAdapter(jl, "D-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD17()
				.addMouseListener(asientoAdapter(jl, "D-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD18()
				.addMouseListener(asientoAdapter(jl, "D-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD19()
				.addMouseListener(asientoAdapter(jl, "D-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getD20()
				.addMouseListener(asientoAdapter(jl, "D-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE10()
				.addMouseListener(asientoAdapter(jl, "E-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE11()
				.addMouseListener(asientoAdapter(jl, "E-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE12()
				.addMouseListener(asientoAdapter(jl, "E-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE13()
				.addMouseListener(asientoAdapter(jl, "E-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE14()
				.addMouseListener(asientoAdapter(jl, "E-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE15()
				.addMouseListener(asientoAdapter(jl, "E-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE16()
				.addMouseListener(asientoAdapter(jl, "E-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE17()
				.addMouseListener(asientoAdapter(jl, "E-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE18()
				.addMouseListener(asientoAdapter(jl, "E-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE19()
				.addMouseListener(asientoAdapter(jl, "E-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getE20()
				.addMouseListener(asientoAdapter(jl, "E-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF10()
				.addMouseListener(asientoAdapter(jl, "F-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF11()
				.addMouseListener(asientoAdapter(jl, "F-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF12()
				.addMouseListener(asientoAdapter(jl, "F-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF13()
				.addMouseListener(asientoAdapter(jl, "F-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF14()
				.addMouseListener(asientoAdapter(jl, "F-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF15()
				.addMouseListener(asientoAdapter(jl, "F-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF16()
				.addMouseListener(asientoAdapter(jl, "F-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF17()
				.addMouseListener(asientoAdapter(jl, "F-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF18()
				.addMouseListener(asientoAdapter(jl, "F-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF19()
				.addMouseListener(asientoAdapter(jl, "F-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getF20()
				.addMouseListener(asientoAdapter(jl, "F-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG10()
				.addMouseListener(asientoAdapter(jl, "G-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG11()
				.addMouseListener(asientoAdapter(jl, "G-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG12()
				.addMouseListener(asientoAdapter(jl, "G-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG13()
				.addMouseListener(asientoAdapter(jl, "G-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG14()
				.addMouseListener(asientoAdapter(jl, "G-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG15()
				.addMouseListener(asientoAdapter(jl, "G-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG16()
				.addMouseListener(asientoAdapter(jl, "G-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG17()
				.addMouseListener(asientoAdapter(jl, "G-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG18()
				.addMouseListener(asientoAdapter(jl, "G-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG19()
				.addMouseListener(asientoAdapter(jl, "G-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getG20()
				.addMouseListener(asientoAdapter(jl, "G-20"));
		...
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH10()
				.addMouseListener(asientoAdapter(jl, "H-10"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH11();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH11()
				.addMouseListener(asientoAdapter(jl, "H-11"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH12();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH12()
				.addMouseListener(asientoAdapter(jl, "H-12"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH13();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH13()
				.addMouseListener(asientoAdapter(jl, "H-13"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH14();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH14()
				.addMouseListener(asientoAdapter(jl, "H-14"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH15();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH15()
				.addMouseListener(asientoAdapter(jl, "H-15"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH16();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH16()
				.addMouseListener(asientoAdapter(jl, "H-16"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH17();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH17()
				.addMouseListener(asientoAdapter(jl, "H-17"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH18();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH18()
				.addMouseListener(asientoAdapter(jl, "H-18"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH19();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH19()
				.addMouseListener(asientoAdapter(jl, "H-19"));
		this.jl = this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH20();
		this.ventanaPrincipal.getPanelDinamico().getPanelDinamico().getH20()
				.addMouseListener(asientoAdapter(jl, "H-20"));
	}
