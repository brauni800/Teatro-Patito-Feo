...
public class EventosObras extends EventosFactory {
	...
	protected void initEvents() {
		...
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.REGRESAR).setActionCommand(PanelFactory.REGRESAR);
		
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.CREAR_OBRA).addActionListener(this);
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.CREAR_OBRA).setActionCommand(PanelFactory.CREAR_OBRA);
		
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.ELIMINAR_OBRA).addActionListener(this);
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.ELIMINAR_OBRA).setActionCommand(PanelFactory.ELIMINAR_OBRA);
		
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.EDITAR_OBRA).addActionListener(this);
		super.ventanaPrincipal.getPanelDinamico().getBoton(PanelFactory.EDITAR_OBRA).setActionCommand(PanelFactory.EDITAR_OBRA);
	}
